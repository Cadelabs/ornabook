...
# B
#### Bluelining
Staying low MP ("blue" bar) to maximize passives such as [Heretic's Iconoclast](https://playorna.com/codex/classes/55/).
...
# R
#### Redlining
Staying low HP ("red" bar) to maximize passives such as [Realmshifter's Resurgence](https://playorna.com/codex/classes/56/).
